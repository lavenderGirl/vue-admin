<template>
	<section>
		<!--工具条-->
		<el-col :span="24" class="search-condition">
		...
		<!--列表-->
		<el-table :data="users" height="440" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="url" label="线上简历" min-width="180" sortable></el-table-column>
